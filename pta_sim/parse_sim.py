...
parser.add_argument('--gp_coeff', dest='gp_coeff', action='store_true',
                    default=False, help='Store all the gp_coeff for a Gaussian Process analysis.')
...
parser.add_argument('--mlv', dest='mlv',
                    action='store_true', default=False,
                    help='Use max likelihood value')
...
parser.add_argument('--n_swgp_freqs', dest='n_swgp_freqs', action='store',
                    type=int, default=20, help='Number of Freqs for SW GP')
