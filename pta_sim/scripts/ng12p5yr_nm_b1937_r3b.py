...
# Add to exponential dips for J1713+0747
                #Model, kernel, Chrom Kernel,Chrom Quad, Index
model_labels = [['A', 'periodic', True, 'sq_exp', True, 4],
                ['B', 'periodic', True, 'periodic', True, 4],
                ['C', 'periodic_rfband', True, 'sq_exp', True, 4],
                ['D', 'periodic_rfband', True, 'periodic', True, 4],
                ]
